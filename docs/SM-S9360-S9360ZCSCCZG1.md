# Galaxy S25+ SM-S9360 / S9360ZCSCCZG1 port record

This record contains the exact inputs and derived values for the China (CHC) Galaxy S25+ profile `pa2q-S9360ZCSCCZG1`.
...
model: SM-S9360
device: pa2q
fingerprint: samsung/pa2qzcx/pa2q:16/BP4A.251205.006/S9360ZCSCCZG1_CHCCCZG1:user/release-keys
kernel release: 6.6.98-android16-6-6-abogkiS9360ZCSCCZG1
...
```sh
make TARGET=pa2q-S9360ZCSCCZG1 ANDROID_NDK_HOME=/path/to/android-ndk
```

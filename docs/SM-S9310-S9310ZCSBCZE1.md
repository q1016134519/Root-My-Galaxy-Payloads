# Galaxy S25 SM-S9310 / S9310ZCSBCZE1 port record

This record contains the exact inputs and derived values for the China (CHC) Galaxy S25 profile `pa1q-S9310ZCSBCZE1`.
...
model: SM-S9310
device: pa1q
fingerprint: samsung/pa1qzcx/pa1q:16/BP4A.251205.006/S9310ZCSBCZE1_CHCBCZE1:user/release-keys
kernel release: 6.6.98-android16-6-6-abogkiS9310ZCSBCZE1
...
| `KMALLOC_CACHES_OFF` | `kmalloc_caches` | `0x017dad90` |
...
| `SELINUX_BLOB_SIZES_OFF` | `selinux_blob_sizes` | `0x017db988` |
| `SECURITY_HOOK_HEADS_OFF` | `security_hook_heads` | `0x017db250` |
...
| `SLIDE_NFULNL_LOGGER_NAME_OFF` | `nfnetlink_log` logger name string (`nfulnl_logger`) | `0x0175e88e` |
...
```sh
make TARGET=pa1q-S9310ZCSBCZE1 ANDROID_NDK_HOME=/path/to/android-ndk
```

# Galaxy S25 SM-S9310 / S9310ZCUACZDP port record

This record contains the exact inputs and derived values for the China (CHC) Galaxy S25 profile `pa1q-S9310ZCUACZDP`.
...
model: SM-S9310
device: pa1q
fingerprint: samsung/pa1qzcx/pa1q:16/BP4A.251205.006/S9310ZCUACZDP_CHCACZDP:user/release-keys
kernel release: 6.6.98-android16-6-6-abogkiS9310ZCUACZDP
...
| `SLIDE_NFULNL_LOGGER_NAME_OFF` | `nfnetlink_log` logger name string (`nfulnl_logger`) | `0x0175e878` |
...
```sh
make TARGET=pa1q-S9310ZCUACZDP ANDROID_NDK_HOME=/path/to/android-ndk
```

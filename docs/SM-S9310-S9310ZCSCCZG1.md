# Galaxy S25 SM-S9310 / S9310ZCSCCZG1 port record

This record contains the exact inputs and derived values for the China (CHC) Galaxy S25 profile `pa1q-S9310ZCSCCZG1`.
...
model: SM-S9310
device: pa1q
fingerprint: samsung/pa1qzcx/pa1q:16/BP4A.251205.006/S9310ZCSCCZG1_CHCCCZG1:user/release-keys
kernel release: 6.6.98-android16-6-6-abogkiS9310ZCSCCZG1
...
| `SLIDE_NFULNL_LOGGER_NAME_OFF` | `nfnetlink_log` logger name string (`nfulnl_logger`) | `0x0175e71c` |
...
```sh
make TARGET=pa1q-S9310ZCSCCZG1 ANDROID_NDK_HOME=/path/to/android-ndk
```
